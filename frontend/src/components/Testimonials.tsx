...
const Testimonials: React.FC = () => {
  return (
    <section className="bg-color2 text-white py-8 h-[70%]">
      <h2 className="text-center text-3xl">Customer Testimonials</h2>
      <div className="flex flex-wrap justify-center gap-8">
        ...
        <div >
              ...
              />
              <div
                className="bg-white text-gray-500 px-2 py-10 rounded-sm shadow-lg w-80"
              >
        ...
        <div >
          ...
          <div className="bg-white text-gray-500 px-2 py-10 rounded-sm shadow-lg w-80">
            <p className="italic text-md  ml-12 mb-4">
            The Dev Shop team has been a critical partner for our business. Not only do they answer the 
            call and go above and beyond each and every day, but more importantly, they build incredible 
            software and work extremely hard to interface with our team to ensure that every deliverable 
            is on time, and above expectation. You can't get any better than the team at The Dev Shop!!
              </p>
            ...
            <div >
              ...
              <div
                className="bg-white text-gray-500 px-2 py-10 rounded-sm shadow-lg w-80"
              >
                <p className="italic text-md ml-20 text-sm mb-4">With The Dev Shop's help we were able to jump start our framework development. This same framework is now used in 54 of our applications.
                  </p>
